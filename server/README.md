...
```text
[DedicatedServer] READY DUALMON_JOIN_CODE=ABC123 BUILD=cloud-authority-v4-20260722
```

Both players select **Join** in DualMon and enter that same code. Neither player
selects **Host** for a cloud-authoritative match.

Both clients must use multiplayer protocol v4 (`cloud-authority-v4-20260722`).
